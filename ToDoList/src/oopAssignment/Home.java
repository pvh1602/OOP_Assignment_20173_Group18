...
public class Home extends JFrame {
	...
	public Home() {
		...
		btnNewTab.setToolTipText("Tạo chủ đề công việc mới");
		...
		btnEdit.setToolTipText("Sửa chủ đề công việc\r\n");
		...
		btnDel.setToolTipText("Xóa chủ đề công việc\r\n");
...
//		pnSetting.setForeground(new Color(175, 238, 238));
//		pnSetting.setLayout(null);
//		pnSetting.setBackground(new Color(0, 128, 0));
//		pnSetting.setBounds(741, 36, 120, 3);
//		pnMenu.add(pnSetting);
//
//		JButton btnSetting = new JButton("Cài đặt");
//		btnSetting.setFont(new Font("Verdana", Font.PLAIN, 11));
//		btnSetting.setIcon(new ImageIcon(Home.class.getResource("/image/setting2.png")));
//		btnSetting.setToolTipText("Cài đặt");
//		btnSetting.setBounds(741, 5, 120, 26);
//		pnMenu.add(btnSetting);
//
//		btnSetting.addMouseListener(new MouseAdapter() {
//			@Override
//			public void mouseEntered(MouseEvent e) {
//				pnSetting.setBackground(new Color(220, 20, 60));
//			}
//
//			@Override
//			public void mouseExited(MouseEvent e) {
...
//			}
//		});
//		btnSave.setIcon(new ImageIcon(Home.class.getResource("/image/save20px.png")));
//		btnSave.setToolTipText("Lưu lại thay đổi");
//		btnSave.setFont(new Font("Verdana", Font.PLAIN, 11));
//		btnSave.setBounds(495, 5, 120, 26);
//		pnMenu.add(btnSave);
//
//		JPanel pnSave = new JPanel();
//		pnSave.setLayout(null);
//		pnSave.setForeground(new Color(175, 238, 238));
//		pnSave.setBackground(new Color(0, 128, 0));
//		pnSave.setBounds(495, 36, 120, 3);
//		pnMenu.add(pnSave);
//		
//		btnSave.addMouseListener(new MouseAdapter() {
//			@Override
//			public void mouseEntered(MouseEvent e) {
//				pnSave.setBackground(new Color(220, 20, 60));
//			}
//
//			@Override
//			public void mouseExited(MouseEvent e) {
